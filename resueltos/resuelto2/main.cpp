...
// título, autor, año y color del libro. El color se deberá hacer mediante una
// enumeración y sólo habrá rojo, verde y azul.
...
void datosLibro(Libro libro[3]) {
  ...
  libro[0].color = Color::rojo;
  libro[1].color = Color::verde;
  libro[2].color = Color::azul;
}
